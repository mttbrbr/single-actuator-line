...
The three horizontal views cover the complete `[-5D,15D] × [-4D,4D]` domain,
including inlet, rotor, wake and outlet. Vorticity uses a black–red–yellow
colour map without a purple interval.
